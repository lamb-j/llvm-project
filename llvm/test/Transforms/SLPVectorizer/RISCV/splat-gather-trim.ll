...
; THRESHOLD-NEXT:    [[AS11:%.*]] = add i64 [[SH1]], [[D0]]
...
; THRESHOLD-NEXT:    [[TMP1:%.*]] = insertelement <4 x i64> [[TMP5]], i64 [[AS11]], i64 1
; THRESHOLD-NEXT:    [[TMP7:%.*]] = insertelement <4 x i64> [[TMP1]], i64 [[AS12]], i64 2
...
; THRESHOLD-NEXT:    [[AS12:%.*]] = add i64 [[SH3]], [[F0]]
; THRESHOLD-NEXT:    [[AS13:%.*]] = sub i64 [[SH2]], [[E0]]
; THRESHOLD-NEXT:    [[TMP0:%.*]] = insertelement <4 x i64> poison, i64 [[AS10]], i64 0
; THRESHOLD-NEXT:    [[TMP5:%.*]] = insertelement <4 x i64> [[TMP0]], i64 [[AS11]], i64 1
